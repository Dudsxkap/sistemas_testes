"""
Django settings for sistema_vacinas project.
...
AUTH_USER_MODEL = 'agendamentos.User'
...
ROOT_URLCONF = 'sistema_vacinas.urls'
...
WSGI_APPLICATION = 'sistema_vacinas.wsgi.application'
